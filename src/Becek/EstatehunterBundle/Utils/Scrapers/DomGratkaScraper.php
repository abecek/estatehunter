...
class DomGratkaScraper extends OfferScraperAbstract implements OfferGeneratorInterface
{
    ...
    public function getHtmlFromUrl($url){
        ...
        curl_setopt($ch, CURLOPT_URL, 'https://gratka.pl/nieruchomosci/mieszkania/zgierz?rodzaj-ogloszenia=sprzedaz&lokalizacja_szerokosc-geograficzna-y=51.855011&lokalizacja_dlugosc-geograficzna-x=19.408392&lokalizacja_region=%C5%82%C3%B3dzkie');
